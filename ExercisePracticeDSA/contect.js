function formFunc(e) {
    ...
    if (userEmail == "") {
        document.getElementById("email_msg").innerHTML = "please fill the useremail field";
...
if(subject == ""){
    document.getElementById("subject_msg").innerHTML = "please fill the subject field";
    document.getElementById("subject_msg").style.color = "#ffcc06";
    return false;
}else{
...
if(comment == ""){
    document.getElementById("comment_msg").innerHTML = "please fill the comment field";
